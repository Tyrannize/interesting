 ...
 */
-(instancetype)initWithFrame:(CGRect)frame withViewControllers:(NSArray *)viewControllers withButtonNames:(NSArray *)names withThreeAnimation:(int)choose;//实例方法
+(instancetype)scrollWithFrame:(CGRect)frame withViewControllers:(NSArray *)viewControllers withButtonNames:(NSArray *)names withThreeAnimation:(int)choose;//类方法
