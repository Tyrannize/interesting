...
-(instancetype)initWithFrame:(CGRect)frame withViewControllers:(NSArray *)viewControllers withButtonNames:(NSArray *)names withThreeAnimation:(int)choose{
    self =[super initWithFrame:frame];
    if (self) {
        self.xl_views = viewControllers;
...
+ (instancetype)scrollWithFrame:(CGRect)frame withViewControllers:(NSArray *)viewControllers withButtonNames:(NSArray *)names withThreeAnimation:(int)choose
{
    return [[self alloc] initWithFrame:frame
                   withViewControllers:viewControllers
                       withButtonNames:names
                    withThreeAnimation:choose];
}
